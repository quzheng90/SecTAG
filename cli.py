...
def get_args():
    parser = argparse.ArgumentParser(description='parameters of SecTAG')

    # Training hyper-parameters
    parser.add_argument('-bs', '--batch-size', help='Batch size', type=int, required=False,default=16)
    parser.add_argument('-lr', '--learning-rate', help='Learning rate', type=float, required=False,default=3e-6)
    parser.add_argument('-wd', '--weight-decay', help='Weight decay', type=float, required=False, default=0)
    parser.add_argument('-ep', '--epochs', help='Number of epochs', type=int, required=False,default=10)
    parser.add_argument('-tr', '--truncate', help='Truncate the sequence length to', type=int, required=False, default=64)
    ...
    parser.add_argument('-ta', '--task', help='Which subtask to run', type=str, required=False,default='all')
    parser.add_argument('-mo', '--model', help='Which model to use', type=str, required=False,default='bert')
    ...
    parser.add_argument('-lw', '--loss-weights', help='Weights for all losses', nargs='+', type=float, required=False, default=[0.4, 0.25, 0.4])
    ...
    parser.add_argument('-hs', '--hidden-size', help='hidden vector size of LSTM', type=int, required=False, default=32)
